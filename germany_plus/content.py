...
LESSONS: tuple[Lesson, ...] = (
    Lesson(
        ...
        questions=(
            Q("¿Dónde está Lula?", ("En un curso de alemán", "En una estación", "En un restaurante", "En su casa"), "En un curso de alemán", "El texto dice que Lula es nueva en un curso de alemán."),
    ...
    Lesson(
        ...
        questions=(
            ...
            Q("¿Qué come?", ("Pan con queso", "Arroz con pollo", "Yogur con fruta", "Solo una manzana"), "Pan con queso", "El texto dice «Brot mit Käse»."),
    ...
    Lesson(
        ...
        questions=(
            ...
            Q("¿Qué comen?", ("Sopa", "Pan", "Pasta", "Ensalada"), "Sopa", "El texto dice «Sie essen Suppe»."),
    ...
    Lesson(
        ...
        questions=(
            Q("¿Qué día es para Lula?", ("Su primer día de trabajo", "Su último día de clases", "Su cumpleaños", "Un día de vacaciones"), "Su primer día de trabajo", "El texto dice «erster Tag» en la oficina."),
    ...
    Lesson(
        ...
        questions=(
            ...
            Q("¿A qué hora sale el tren?", ("A las diez", "A las nueve", "A las once", "A las doce"), "A las diez", "El texto dice «um zehn Uhr»."),
    ...
    Lesson(
        ...
        questions=(
            Q("¿Con quién se encuentra Lula?", ("Con Ana", "Con Jonas", "Con su jefe", "Con Frau Weber"), "Con Ana", "El texto dice «Lula trifft Ana»."),
            ...
            Q("¿Cómo es el café?", ("Tranquilo", "Muy ruidoso", "Vacío y oscuro", "Grande y caro"), "Tranquilo", "El texto dice «Das Café ist ruhig»."),
    ...
    Lesson(
        ...
        questions=(
            ...
            Q("¿Qué otro síntoma tiene?", ("Está muy cansada", "Tiene tos", "No puede caminar", "Tiene frío"), "Está muy cansada", "El texto dice «sehr müde»."),
    ...
    Lesson(
        ...
        questions=(
            ...
            Q("¿Cuántos amigos juegan fútbol?", ("Dos", "Uno", "Tres", "Todos"), "Dos", "El texto dice «zwei Freunde»."),
